...
import { LogOut, LogIn, User, Calendar, LayoutDashboard, Settings, Menu, X, UserPlus, UserCheck, Laptop, Sparkles } from "lucide-react";
                ...
                <div className="flex items-center gap-4">
                    {isLoggedIn ? (
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <Link href="/register" className="h-10 px-5 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-semibold text-xs transition-all duration-200 flex items-center gap-1.5 shadow-md active:scale-95 cursor-pointer">
                            ...
                            <div className="space-y-6 pt-6 border-t border-zinc-150 dark:border-zinc-900">
                                ...
                                {isLoggedIn ? (
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <Link href="/register" onClick={() => setIsMobileMenuOpen(false)} className="w-full h-12 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-semibold text-xs transition-all duration-200 flex items-center justify-center gap-1.5 shadow-md">
                                            <UserPlus className="w-3.5 h-3.5" />
